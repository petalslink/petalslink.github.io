...
[Access the last downloads](/download-petals-4.2.2.html).
...
A snapshot of the next maintenance version (4.2.3) of Petals ESB is available [here](http://repository.ow2.org/nexus/service/local/artifact/maven/content?r=snapshots&g=org.ow2.petals&a=petals-esb-enterprise-edition&v=4.2.3-SNAPSHOT&p=zip).
